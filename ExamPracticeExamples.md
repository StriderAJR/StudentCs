...
`cd`: принимает в качестве параметра "." - перейти на папку выше или имя папки, в которую перейти. После перехода отображается список файлов и папок в новом местоположении.
`new`: принимает имя файла с разрешением. Создает новый файл в текущей папке
