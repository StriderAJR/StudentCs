...
- [Задание 13. Очереди, стеки, дженерики](#задание-13)
- [Задание 14. yield return](#задание-14)
- [Задание 15. Листы и словари](#задание-15)
- [Задание 16. Делегаты](#задание-16)
- [Задание 17. LINQ](#задание-17)
...
[Присоединиться к учебной группе на uLearn](https://ulearn.me/Account/JoinGroup?hash=23168960-6d0f-4af0-9d31-f63dd8ea5249). uLearn в целом это самодостаточная платформа с видео лекциями и заданиями с автоматической проверкой. Но задания там становятся чем дальше, тем мудреннее и сложнее. Поэтому сначала мы будем выполнять задания в модулях, а затем будем какие-то пропускать, а в дальнейшем полностью перейдем на наши отдельные лабы, которые будут попроще и попонятнее. А вот в самом начале там хороший набор простеньких заданий, на тренировку простых тем. 
...
Пройти модуль [Очереди, стеки, дженерики](https://ulearn.me/course/basicprogramming2/cdf76069-758c-4a3c-aacb-df3fa877cac5). 

## Задание 14

Пройти модуль [yield return](https://ulearn.me/course/basicprogramming2/c334ede2-2c35-4fcb-94cb-fb1c48e3e7bb). Не выполнять задание "Скользящий максимум".

## Задание 15

Пройти модуль [Листы и словари](https://ulearn.me/course/basicprogramming/20fe68058-4d3b-24ea-8f31-aa1cc603f27a). Не выполнять задание "Ghosts".

## Задание 16

Пройти модуль [Делегаты](https://ulearn.me/course/basicprogramming/a1638296-d6ca-4038-8bbc-4d92bc9c054f).
