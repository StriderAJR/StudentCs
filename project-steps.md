...
<details>
<summary>Общая концепция</summary>
...
1. Реализовать отдельную команду для отображения информации об игроке (очки движения, очки заклинаний, экипировка, слоты юнитов).  
1. Добавить возможность выбора типа игрока при старте.  
1. Хранить характеристики игрока (скорость, сила магии, количество слотов для юнитов) в кортеже.  
1. Реализовать метод для расчета доступного количества ходов в день в зависимости от типа.  
1. Добавить рекурсивный метод для отрисовки карты (например, проход по строкам).  
1. Использовать параметры по ссылке для изменения характеристик игрока (например, временный бонус из конюшни).  
...
<details>
<summary>Лабораторная работа 10</summary>
...
<details>
<summary>Лабораторная работа 11.1</summary>
...
<details>
<summary>Лабораторная работа 11.2</summary>
...
<details>
<summary>Лабораторная работа 12.1  </summary>
...
<details>
<summary>Лабораторная работа 12.2  </summary>
...
<details>
<summary>Лабораторная работа 12.3</summary>
