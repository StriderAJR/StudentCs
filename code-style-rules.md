Понял. Я полностью сохраню все твои примеры, исправленные и исходные, но пересортирую их по темам, которые логично изучать последовательно при обучении программированию:

* Базовые правила форматирования и именования
* Операторы, арифметика и булевы выражения
* Управление потоком: if/else, ветвления, циклы
* Методы: разбиение, вложенные методы, повторяемость кода
* Работа с переменными и типами
* Работа с файлами
* Примеры комплексных программ: калькулятор, баланс

Также я учту уточнение по "висящим" блокам.
