...
namespace TempCs
{
    class Program
    {
        ...
        private static string GetFigureRusName(FigureType figure)
        {
            switch(figure)
            {
                case FigureType.Pawn:   return "Пешка";
                case FigureType.Knight: return "Конь";
                case FigureType.Rook:   return "Ладья";
                case FigureType.Bishop: return "Ферзь";
                case FigureType.Queen:  return "Королева";
                case FigureType.King:   return "Король";
            }
        ...
        private static void TryMove(Dictionary<char, Dictionary<char, char>> board, string start, string end, Func<Dictionary<char, Dictionary<char, char>>, string, string, bool> checkMethod, FigureType figure)
        {
            if(!checkMethod(board, start, end))
            {
                Console.WriteLine(GetFigureRusName(figure) + wrongCoordinatesMessage);
                return;
            }

            // меняем позицию фигуры на доске
            MoveFigure(board, start, end, figure);
        }

        private static bool IsKnightCorrect(Dictionary<char, Dictionary<char, char>> board, string start, string end)
        {
        ...
        private static bool IsKingCorrect(Dictionary<char, Dictionary<char, char>> board, string start, string end)
        {
        ...
        private static bool IsPawnCorrect(Dictionary<char, Dictionary<char, char>> board, string start, string end)
        {
            throw new NotImplementedException();
        }
